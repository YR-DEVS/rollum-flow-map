  ...
  public: {
    Tables: {
      ...
      likes1: {
        ...
        Relationships: [
          {
            foreignKeyName: "likes1_reply_id_fkey"
            columns: ["reply_id"]
            isOneToOne: false
            referencedRelation: "replies1"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "likes1_topic_id_fkey"
            columns: ["topic_id"]
            isOneToOne: false
            referencedRelation: "topics1"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "likes1_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "users1"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      online_tournaments: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_online_tournaments_winner"
            columns: ["winner_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      replies1: {
        ...
        Relationships: [
          {
            foreignKeyName: "replies1_author_id_fkey"
            columns: ["author_id"]
            isOneToOne: false
            referencedRelation: "users1"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "replies1_topic_id_fkey"
            columns: ["topic_id"]
            isOneToOne: false
            referencedRelation: "topics1"
            referencedColumns: ["id"]
      ...
      topics1: {
        ...
        Relationships: [
          {
            foreignKeyName: "topics1_author_id_fkey"
            columns: ["author_id"]
            isOneToOne: false
            referencedRelation: "users1"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "topics1_category_id_fkey"
            columns: ["category_id"]
            isOneToOne: false
      ...
      user_market_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "user_market_items_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
